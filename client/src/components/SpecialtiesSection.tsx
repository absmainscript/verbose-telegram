    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          >
            <span className={`text-xs font-medium uppercase px-6 py-2 rounded-full ${badgeGradientCSS ? `text-transparent bg-clip-text bg-gradient-to-r ${badgeGradientCSS}` : 'text-purple-600'}`}>
              {sectionTexts.badge}
            </span>
          </motion.div>
