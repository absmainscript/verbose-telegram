...
export function ServicesSectionTextsForm({ configs }: ServicesSectionTextsFormProps) {
  ...
  const form = useForm<ServicesTextsForm>({
    ...
    defaultValues: {
      title: servicesTexts.title || "Meus Serviços",
      subtitle: servicesTexts.subtitle || "Como posso te ajudar",
      description: servicesTexts.description || "Ofertas terapêuticas personalizadas para seu bem-estar",
    },
  });
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="Meus Serviços" {...field} />
              </FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="Como posso te ajudar" {...field} />
              </FormControl>
              <div className="text-xs text-muted-foreground">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea 
                  placeholder="Ofertas terapêuticas personalizadas para seu bem-estar" 
                  rows={3} 
                  {...field} 
                />
              </FormControl>
